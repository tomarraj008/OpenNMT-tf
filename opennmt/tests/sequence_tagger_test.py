...
class SequenceTaggerTest(tf.test.TestCase):
  ...
  def _testTagSchemeFlags(self,
    ...
    variables = true_positives.variables + false_positives.variables + false_negatives.variables
    update_ops = [
    ...
    with tf.Session() as sess:
      ...
      true_positives, false_positives, false_negatives = sess.run([
          true_positives.result(), false_positives.result(), false_negatives.result()])
